        ...
        <div class="bg-yellow-50 p-8 rounded-lg shadow-lg w-full max-w-lg max-h-[90vh] overflow-auto">
            ...
            <form method="POST" action="{{ route('session.store') }}" enctype="multipart/form-data" class="space-y-6">
                ...
                <div class="mt-4">
                    ...
                    <input type="date" name="trainsession_date" class="w-full p-3 border @error('trainsession_date') border-red-500 @else border-orange-200 @enderror rounded-lg">
                    @error('trainsession_date')
                        <div class="text-red-500 text-sm">{{ $message }}</div>
                    @enderror
                </div>

                <!-- Start Time with Error -->
                <div class="mt-4">
                ...
                <div class="mt-4">
                    ...
                    <textarea name="description" id="description" rows="4" class="w-full p-3 border @error('description') border-red-500 @else border-orange-200 @enderror rounded-lg"></textarea>
                    @error('description')
                        <div class="text-red-500 text-sm">{{ $message }}</div>
                    @enderror
                </div>
